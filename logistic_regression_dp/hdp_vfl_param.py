...
class HdpVflParam(BaseParam):
    ...
    以下几个参数与差分隐私有关，凸优化参数。因为如下参数都是位于公式中的，可以直接赋值。
    ...
    """
    def __init__(self,epsilon=1,delta=0.01,L=1,beta_theta=0.25,beta_y=1.1,
                 e=15,r=3,k=1,learning_rate=0.05,lamb=0.001,k_y=1):
